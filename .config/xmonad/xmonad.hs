...
myPrompt = def
  ...
  , promptBorderWidth = 0
  , font              = "xft:UbuntuMono Nerd Font Mono:size=11"
  }
...
myStartupHook = do
                spawnOnce "feh --bg-scale ~/Imágenes/image.jpg &"
...
main = do
        ...
        xmonad $ docks def
            ...
            logHook            = dynamicLogWithPP xmobarPP
                                    ...
                                    , ppCurrent = xmobarColor "#ffff5f" "" -- Current workspace in xmobar
                                    , ppHidden = xmobarColor "#00ffff" "" . wrap "\xf069 " ""   -- Hidden workspaces in xmobar
                                    ...
                                    , ppSep =  "<fc=#949494> | </fc>"                     -- Separators in xmobar
